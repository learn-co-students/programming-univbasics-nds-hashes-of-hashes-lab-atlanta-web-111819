...
def naming_system
  ...
  bio_life = {:label => "Kingdom", :sub_category => {:label => "Phylum", :sub_category => {:label => "Class", :sub_category => {:label => "Order", :sub_category => {:label => "Genus", :sub_category => {:label => "Genus", :sub_category => {
    :label => "Species"}}}}}
  }}
  bio_life
